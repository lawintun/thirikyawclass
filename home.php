...
<h3 class="title">TUM THE WHOLE FRESHER WELCOME (Dance KRP) </h3>
</div>
</div>
<div class="video-list">
<div class="vid active" onclick="encoding(this.id)" id="act">
<iframe class="responsive-iframe" id="MyFrame" src="https://www.youtube.com/embed/DpH_KTXuVHQ" allow="autoplay" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
<h3 class="title">TUM THE WHOLE FRESHER WELCOME (Dance KRP) </h3>
</div>
...
<iframe  class="responsive-iframe" id="MyFrame" src="https://www.youtube.com/embed/EXdnZX1_h5g" allow="autoplay" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
<h3 class="title">TUM THE WHOLE FRESHER WELCOME PART-30 </h3>
</div>
...
<iframe  class="responsive-iframe" id="MyFrame" src="https://www.youtube.com/embed/fla8ztStJdM" allow="autoplay" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
